...
void compute_continued_fraction_elements(const int num, const int den, int res[], const int res_maxdim, int i=0) {
    ...
    int d = (num%den)/g;
    int n = den/g;
    compute_continued_fraction_elements(n, d, res, res_maxdim, i+1);
}
